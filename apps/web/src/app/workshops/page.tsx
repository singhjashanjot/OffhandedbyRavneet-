...
export const metadata: Metadata = {
  ...
  description: "Book the latest upcoming art workshops in Jalandhar, Chandigarh, Mohali, Ludhiana, Punjab, and across India. Explore pottery, texture art, and premium painting classes.",
};
